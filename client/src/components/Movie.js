...
const Movie = (props) => {
    const { addToFavorites, deleteMovie } = props;//9b you must add "deleteMovie here in props to "see" the res data produced from 9A below in the handle click. note at this point deleteMovie in App.js is NOT complete nore is handleClick YET below. That occurs in other steps. This is also Step 11. 
    ...
    useEffect(() => {
        axios.get(`http://localhost:5001/api/movies/${id}`)
            .then(res => {
                // console.log('Movie.js ln:17 GET res:', res);
                // console.log('Movie.js ln:17 GET res.data:', res.data);
                setMovie(res.data);
            })
            .catch(err => {
    ...
    const handleClick = () => {
        axios.delete(`http://localhost:5001/api/movies/${id}`)
            .then(res => {
                ...
                // console.log('Move.js ln:25 res', res);
                // console.log('Move.js ln:26 res', res.data);
